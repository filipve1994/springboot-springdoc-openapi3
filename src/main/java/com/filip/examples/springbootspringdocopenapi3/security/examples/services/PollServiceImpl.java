...
import com.filip.examples.springbootspringdocopenapi3.errorhandling.exceptions.BadRequestException;
...
import com.filip.examples.springbootspringdocopenapi3.security.examples.models.Choice;
import com.filip.examples.springbootspringdocopenapi3.security.examples.models.ChoiceVoteCount;
import com.filip.examples.springbootspringdocopenapi3.security.examples.models.Poll;
import com.filip.examples.springbootspringdocopenapi3.security.examples.models.Vote;
...
import com.filip.examples.springbootspringdocopenapi3.security.examples.utils.ModelMapper;
...
public class PollServiceImpl implements PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
        ...
        Map<Long, ApplicationUser> creatorMap = getPollCreatorMap(polls.getContent());
    ...
    public PagedResponse<PollResponse> getPollsVotedBy(String username, UserPrincipal currentUser, int page, int size) {
        ...
        Map<Long, Long> choiceVoteCountMap = getChoiceVoteCountMap(pollIds);
        Map<Long, Long> pollUserVoteMap = getPollUserVoteMap(currentUser, pollIds);
        Map<Long, ApplicationUser> creatorMap = getPollCreatorMap(polls);
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        ApplicationUser creator = userRepository.findByUsername(poll.getCreatedBy());
        if (creator == null) {
            throw new ResourceNotFoundException("User", "id", poll.getCreatedBy());
        }
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        ApplicationUser user = userRepository.getOne(currentUser.getId());
    ...
    Map<Long, ApplicationUser> getPollCreatorMap(List<Poll> polls) {
        ...
        //List<ApplicationUser> creators = userRepository.findByIdIn(creatorIds);
        List<ApplicationUser> creators = userRepository.findByUsernameIn(creatorIds);
